    ...
    public class Material
    {
        ...
        public void SetUpTev(bool hasTexture, bool hasVtxColor, int texIndex, string texName, Assimp.Material meshMat)
        {
            ...
            if (hasTexture)
            {
                ...
                AddTexMatrix(TexGenType.Matrix3x4, 0, OpenTK.Mathematics.Vector3.Zero, OpenTK.Mathematics.Vector2.One, 0, OpenTK.Mathematics.Vector2.Zero, OpenTK.Mathematics.Matrix4.Identity);

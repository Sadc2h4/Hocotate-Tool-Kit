...
I apologize for using this information without prior credit, and thank the authors for sharing it.
...
このため，GameCube ディスク機能の検証基準は「Dolphin で認識されること」と
「再抽出した `files` が一致すること」です．
